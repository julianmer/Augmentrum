...
class SpatialAugmentations(BaseModule):
    ...
    def route_pipeline(
        ...
        **kwards
        ...
        '''
        Docstring for route_pipeline
        
        This is to route the data through the respective augmentation pipelines.
        This should also cope with differentiating between needing the nifti_list
        or process_tensor forward calls.
        
        :param self: Description
        :param data_list: Description
        :param water_liste: Description
        :param csm_list: Description
        :param aug_list: Description
        :param kwards: Description
        '''
