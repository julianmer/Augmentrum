...
DEFAULT_CONFIG = {
    # Data paths
    'data_dir': '/home/john/Documents/Research/COWS',      # COWS data (openneuro TWIX format)
    'basis_dir': '/home/john/Documents/Research/COWS/ospreybasis_marss_to_cows_26.mat',   # Default basis set (JSON format)

    # Output
    'save_dir': '/home/john/Documents/Research/COWS/results/',

    # COWS data selection
    'location': 'OCCIPITAL',       # None = all locations, or 'OCCIPITAL', 'PARIETAL', 'PFL'
    'water_sup': 'COWS7',      # None = all, or 'VAPOR', 'COWS7', 'COWS12'

    # Fitting parameters
    'method': 'MH',         # 'Newton' (fast) or 'MH' (Bayesian, slow)
